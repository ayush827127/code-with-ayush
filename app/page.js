          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col items-center mb-12">
              ...
              <p className="text-center text-indigo-800 font-medium mb-8 text-lg italic max-w-2xl">
                "Experience a design that's not just beautiful—but built for users."
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col items-center mb-12">
              ...
              <p className="text-center text-purple-800 font-medium mb-8 text-lg italic max-w-2xl">
                "Bring dynamic features to life with fast, secure, and flexible APIs designed for modern web development."
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col items-center mb-12">
              ...
              <p className="text-center text-blue-800 font-medium mb-8 text-lg max-w-2xl">
                Quick, structured, and logical notes to make your coding journey smooth.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Whether you're just starting out or looking to level up your skills, we've got all the resources you need to succeed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Hands-On Learning</h3>
              <p className="text-gray-700">Explore practical coding tutorials and build real-world projects step by step.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-purple-700 mb-3">Built for Beginners</h3>
              <p className="text-gray-700">Start from scratch with beginner-friendly resources and intuitive designs.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-pink-700 mb-3">Developer Tools</h3>
              <p className="text-gray-700">Access APIs, UI kits, code snippets, and quick notes to speed up your development process.</p>
            </motion.div>
          </div>
        </div>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="mx-auto text-center max-w-2xl mb-16">
            <h2 className="text-5xl font-bold text-indigo-700 mb-6">Why Choose Code with Ayush?</h2>
            <p className="text-lg text-gray-700 mb-10">Built by developers, for developers. Here's what makes us stand out:</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <h3 className="font-semibold text-xl text-blue-600 mb-3">Curated Content</h3>
              <p className="text-gray-600">Every course, note, and API is handpicked to ensure relevance and quality.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-xl text-purple-600 mb-3">Beginner-Friendly</h3>
              <p className="text-gray-600">Our materials are designed to be clear, practical, and beginner-focused.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-xl text-pink-600 mb-3">Developer Tools</h3>
              <p className="text-gray-600">Use real APIs and ready-made UI designs to build and practice like a pro.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <div className="bg-white/80 rounded-2xl p-6 text-center shadow-md">
              <span className="block text-4xl font-bold text-blue-600 mb-2">300+</span>
              <span className="text-gray-600 font-medium">UI Components</span>
            </div>
            <div className="bg-white/80 rounded-2xl p-6 text-center shadow-md">
              <span className="block text-4xl font-bold text-purple-600 mb-2">50+</span>
              <span className="text-gray-600 font-medium">Free APIs</span>
            </div>
            <div className="bg-white/80 rounded-2xl p-6 text-center shadow-md">
              <span className="block text-4xl font-bold text-pink-600 mb-2">120+</span>
              <span className="text-gray-600 font-medium">Code Tutorials</span>
            </div>
            <div className="bg-white/80 rounded-2xl p-6 text-center shadow-md">
              <span className="block text-4xl font-bold text-indigo-600 mb-2">8,000+</span>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-indigo-800 mb-6">Popular Categories</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Find exactly what you need to take your development skills to the next level.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto">
            <div className="text-center text-white mb-8">
              <h2 className="text-3xl font-bold mb-4">Stay Updated with New Content</h2>
              <p className="mb-6 text-lg opacity-90">Join our newsletter for weekly tips, project ideas, and resource updates.</p>
            </div>
              ...
              <form className="flex flex-col gap-6">
                <div className="relative">
                  <input
                    ...
                    id="email"
                    placeholder=" "
                    className={`px-4 py-4 rounded-xl bg-white/80 backdrop-blur-sm w-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 ${isNewsletterFocused ? 'border-indigo-500' : 'border-transparent'}`}
                    onFocus={() => setIsNewsletterFocused(true)}
                    onBlur={(e) => setIsNewsletterFocused(e.target.value !== "")}
                  />
                  <label
                    htmlFor="email"
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Find answers to common questions about our platform, resources, and learning approach.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold text-xl text-indigo-700 mb-3">Is this platform free to use?</h3>
              <p className="text-gray-700">Yes, most of the content including APIs, notes, and design resources are completely free to explore and use. We're committed to making coding education accessible to everyone.</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold text-xl text-indigo-700 mb-3">Who can benefit from this website?</h3>
              <p className="text-gray-700">Beginners, students, and aspiring developers looking for curated, beginner-friendly resources to level up their coding skills. Our platform is designed to help you build real-world projects that enhance your portfolio.</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold text-xl text-indigo-700 mb-3">How often is content updated?</h3>
              <p className="text-gray-700">New designs, APIs, and learning materials are added every month. We're constantly working to bring you the latest tools, techniques, and resources that align with industry standards. Make sure to subscribe to stay updated!</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold text-xl text-indigo-700 mb-3">Can I use these resources in my projects?</h3>
              <p className="text-gray-700">Absolutely! All resources are available for both personal and commercial projects. We just ask that you don't resell our templates or resources as your own products.</p>
            </div>
          </div>
        </div>
      </motion.section>
